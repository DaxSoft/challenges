...
export const THEME_COLOR = {
    ...
    background: '#EAF0FB',
    backgroundDiff: fade('#FBFFFD', 0.9),
}
...
export const GRADIENT_COLOR = {
    primary: {
        main: `linear-gradient(45deg, ${THEME_COLOR.primary.main} 30%, ${THEME_COLOR.primary.bridge} 90%)`,
    ...
    background: linerGradient('circle farthest-corner at 10% 20%', [
        ['#F5F5FF', 6],
        [THEME_COLOR.background, 90],
    ]),
}
...
export const PALLETE_COLORS = {
    background: {
        default: THEME_COLOR.background, // #F3F5FA
